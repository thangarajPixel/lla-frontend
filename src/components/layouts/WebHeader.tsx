          ...
          <div className="flex items-center justify-between py-3 pt-2!">
            <LinkWidget href="/">
              <ImageWidget
                ...
                alt="Logo"
                className={isSticky ? "mt-2 md:mt-0 w-60 2xl:w-70 3xl:w-[348px] h-auto relative" : "mt-2 md:mt-0 w-60 2xl:w-70 3xl:w-[348px] h-auto relative md:top-[7px]"}
              />
            </LinkWidget>

            <ul className="hidden lg:flex items-center gap-7 lg:gap-[14px] xl:gap-[38px] 2xl:gap-[46px] text-[14px] 2xl:text-[14px] 3xl:text-[18px]">
              {menuItems.map((item) => {
                if (isDropdown(item)) {
