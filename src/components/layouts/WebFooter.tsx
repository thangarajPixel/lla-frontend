    ...
    >
      <ContainerWidget>
        <div className="flex flex-col items-start justify-start gap-5 md:gap-6">
          <h6 className="text-[32px] md:text-[40px] lg:text-[50px] 3xl:text-[56px] font-normal font-urbanist">
            Let Your Passion Shine Through
          </h6>
          <p className="text-[14px] md:text-[16px] lg:text-[14px] 3xl:text-[24px] font-normal max-w-full md:max-w-[550px]">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-5 py-3 pb-0 w-full">
            <div className="flex flex-col items-start justify-start gap-6 w-full md:w-auto">
              ...
              <div className="flex flex-row items-start justify-start gap-6">
                <div className="flex flex-row gap-2">
                  ...
                  <div>
                    <p className="text-[14px] md:text-[16px] lg:text-[14px] 3xl:text-[18px] font-normal">
                      Light & Life Academy,
                    </p>
                    <p className="text-[14px] md:text-[16px] lg:text-[14px] 3xl:text-[18px] font-normal">
                      Lovedale, Ooty,
            ...
            <div className="flex flex-row md:hidden gap-6 w-full">
              <div className="flex flex-col items-start justify-start gap-3 flex-1">
                ...
                <ul className="flex flex-col items-start justify-start gap-2 text-[14px] md:text-[16px] lg:text-[14px] 3xl:text-[18px] font-normal leading-7">
                  <li>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-start gap-4 sm:gap-6 md:gap-23 py-3 w-full">
            <ImageWidget
              src={LlaOutreach}
              alt="LlaOutreach"
          ...
          <p className="text-[12px] md:text-[14px] lg:text-[14px] 3xl:text-[18px] font-normal max-w-full md:max-w-[350px]">
            © 2025 Light & Life Academy, Premier College for Professional
