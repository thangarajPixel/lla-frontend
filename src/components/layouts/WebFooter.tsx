    ...
    >
      <ContainerWidget>
        <div className="flex flex-col items-start justify-start gap-5">
          <h6 className="lg:text-[50px] 3xl:text-[56px]  font-normal font-urbanist">
            Let Your Passion Shine Through
          </h6>
          <p className="text-[16px] lg:text-[14px] 3xl:text-[24px] font-normal max-w-[550px]">
          ...
          <div className="flex gap-5 py-3 pb-0">
            ...
            <div className="flex flex-col items-start justify-start gap-3 min-w-[250px]">
              <h6 className="text-[20px] 3xl:text-[24px] font-normal font-urbanist">
                Quick Links
              </h6>
          ...
          <p className="text-[16px] lg:text-[14px] 3xl:text-[18px] font-normal max-w-[350px]">
