...
const AboutHeroSection = ({ data }: AboutHeroSectionProps) => {
  return (
    <Fragment>
      <section className="w-full bg-white h-auto sm:min-h-[300px] md:min-h-[250px] lg:min-h-[260px] xl:min-h-[250px] 2xl:min-h-[320px] 3xl:min-h-[320px]">
        <ContainerWidget>
          <div className="flex flex-col items-start justify-start gap-2 md:gap-2">
            ...
            <ScrollWidget animation="fadeUp" delay={0.3}>
              <p className="text-[16px] sm:text-[16px] lg:text-[16px] 
                ...
                font-regular text-black leading-[24px]   md:leading-[26px]
                w-full md:max-w-[650px] xl:max-w-[750px] 2xl:max-w-[850px] 
