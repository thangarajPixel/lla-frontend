...
const TeamSection = () => {
  return (
    <section className="w-full bg-white py-8 sm:py-10 md:py-12 lg:py-14 xl:py-14 2xl:py-20 3xl:py-24">
      <ContainerWidget>
        <div className="text-center space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-4 xl:space-y-6 2xl:space-y-12 3xl:space-y-16">
          <ScrollWidget delay={0.1}>
            <h3
              className="
                ...
                xl:text-6xl 2xl:text-[70px] 3xl:text-[80px]
              "
            >
              The Team
            </h3>
          ...
          <ScrollWidget delay={0.1}>
            <p
              className="
                ...
                xl:text-3xl 2xl:text-[32px] 3xl:text-[40px]
                sm:max-w-[480px] md:max-w-[650px] lg:max-w-[750px] xl:max-w-[850px] 2xl:max-w-[900px]
                mx-auto mb-8
              "
            >
              Lorem ipsum
        ...
        <div className="bg-[#ECECEC] py-5 px-4 sm:px-5 md:px-6 lg:px-8 xl:px-5 2xl:px-12">
          <ScrollWidget delay={0.5} animation="fadeUp">
            <div
              className="
                relative  w-full 
                h-[320px] sm:h-[380px] md:h-[420px] 
                lg:h-[400px] xl:h-[400px] 2xl:h-[520px] 3xl:h-[600px]
              "
            >
              <ImageWidget
                src={TeamGroupDummy}
            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-5 py-4">
              <h5
                className="
                  ...
                  xl:text-3xl 2xl:text-[55px] 3xl:text-[70px]
                "
              >
                Akkas & Annas
              </h5>
              ...
              <p
                className="
                  ...
                  xl:text-[16px] 2xl:text-[18px] 3xl:text-[20px]
                  w-full
                "
              >
