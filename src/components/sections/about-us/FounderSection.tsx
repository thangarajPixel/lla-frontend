        ...
        <div className="text-center space-y-1  xs:space-y-2 sm:space-y-3 md:space-y-5 lg:space-y-6 xl:space-y-4  2xl:space-y-4  3xl:space-y-10 4xl:space-y-14">
          ...
          <ScrollWidget delay={0.1}>
            <p className="font-mulish font-regular text-black text-left xs:text-left md:text-center
                        ...
                        xs:max-w-[600px] sm:max-w-[650px] md:max-w-[700px] lg:max-w-[850px] xl:max-w-[600px]">
              {data.Heading}
          ...
          <div  className=" grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-14 lg:gap-16 xl:gap-18 2xl:gap-20 3xl:gap-24 items-center " >
            <ScrollWidget delay={0.2} className="order-2 md:order-1">
              <div  className="space-y-3 xs:space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-4 4xl:max-w-[420px]">
                ...
                <p className=" font-mulish text-black leading-normal text-[13px]
              text-[16px]
              xs:text-[16px]
              sm:text-[16px]
              lg:text-[16px]
            ...
            <ScrollWidget delay={0.3} className="order-1 md:order-2">
              ...
              <div className="flex justify-center md:justify-start w-full">
                <ImageWidget
                  ...
                  width={500}
                  height={600}
                  className="object-cover w-[360px] h-[480px] xs:w-[420px] xs:h-[530px] sm:w-[400px] sm:h-[500px]
                              md:w-[340px] md:h-[460px]  lg:w-[380px] lg:h-[520px] xl:w-[400px] xl:h-[500px]  2xl:w-[420px] 2xl:h-[560px] 3xl:w-[430px] 3xl:h-[580px] 4xl:w-[450px] 4xl:h-[600px] " />
              </div>
            </ScrollWidget>
          </div>
          <div  className=" grid grid-cols-1 md:grid-cols-2  gap-6  xs:gap-10
                            sm:gap-12 md:gap-14 lg:gap-16 xl:gap-18 2xl:gap-20 3xl:gap-24 items-center ">
            <ScrollWidget delay={0.3}>
              ...
              <div className="flex justify-center md:justify-end w-full">
                <ImageWidget
                  ...
                  width={500}
                  height={600}
                  className="object-cover w-[360px] h-[480px] xs:w-[420px] xs:h-[530px]  sm:w-[300px] sm:h-[380px]
              md:w-[340px] md:h-[440px]  lg:w-[380px] lg:h-[500px]  xl:w-[400px] xl:h-[530px]  2xl:w-[420px] 2xl:h-[550px]  3xl:w-[430px] 3xl:h-[570px] 4xl:w-[450px] 4xl:h-[590px] " />
              </div>
            </ScrollWidget>
            <ScrollWidget delay={0.2}>
              ...
              <h4 className="font-urbanist font-semibold text-[#E97451] block hidden md:block
              text-[24px] xs:text-[26px] sm:text-[26px]  md:text-[28px] lg:text-[28px]  xl:text-[32px] 2xl:text-[36px] 3xl:text-[40px] ">
                   {data.Founder_card[1].Heading}
                </h4>
                <p className="font-mulish text-black leading-normal text-[16px] xs:text-[16px]
                  sm:text-[16px] lg:text-[16px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[18px] ">
