      ...
      >
        ...
        <div className="flex lg:ml-20 xl:ml-36 md:w-full lg:w-[33%] 3xl:w-[35%] flex-col lg:items-center gap-6 pt-8 2xl:pt-0 mb-8 3xl:py-16 3xl:mt-6">
          ...
          {admissionData?.Payment_Status !== "Paid" && (
            <div
              className="flex flex-row items-center justify-between gap-3 w-full lg:w-[300px] lg:-ml-4 xl:w-[350px] 2xl:w-[400px] 2xxl:w-[420px] 3xl:w-[519px] xl:ml-2 2xl:ml-12 2xxl:ml-18 3xl:ml-18 px-4 lg:px-0"
            >
              <ButtonWidget
                className={cn(
