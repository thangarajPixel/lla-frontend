  ...
  return (
    <div className="w-full min-h-screen flex justify-center">
      ...
      >
        ...
        <Card className="bg-[#FBE3DC] flex-1 backdrop-blur lg:py-14 3xl:py-24 3xl:pl-6 3xl:mt-10 border-none shadow-none rounded-none">
          <CardContent
            ...
            // data-lenis-prevent
            className="space-y-8 text-sm lg:max-w-[90%] xl:max-w-[75%] 2xl:mt-10 3xl:mt-0 3xl:max-w-3/4"
          >
            <Section
