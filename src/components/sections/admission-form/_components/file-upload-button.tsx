    ...
    return (
        <div className="space-y-1">
            <button
                ...
                className={`flex items-center justify-center gap-2 w-full py-3 px-4 cursor-pointer rounded-lg transition-colors ${variant === "light"
            ...
            />
            <p>{fileName}</p>
            <p className="text-xs text-muted-foreground">Max. file size not more than {maxSize}.</p>
