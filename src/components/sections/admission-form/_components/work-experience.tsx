...
export function WorkExperience({ control }: WorkExperienceProps) {
    ...
    const handleAddExperience = () => {
        append({ designation: "", employer: "", duration_start: "", duration_end: "", reference_letter: undefined });
    }
        ...
        <div className="space-y-6">
            ...
            <div className="hidden grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <Input placeholder="Enter duration (e.g., 2 years)" className="rounded-full border-border h-11" />
                </div>
                    ...
                    <div key={experience.id} className="space-y-6">
                        {
                            index > 0 && (
                                <div className="flex items-center justify-between">
                                    <h2 className="mb-4 text-chart-1 font-medium">Work Experience - {index}</h2>
                                    <ButtonWidget onClick={() => remove(index)} className="bg-chart-1 text-white hover:bg-chart-1/80 w-24">Remove</ButtonWidget>
                                </div>
                            )
                        }
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="rounded-full border-border h-11"
                                /> */}
                                <FormInput name={`Work_Experience.${index}.designation`} label="Role / Designation" placeholder="Enter your designation or role in the company" control={control} />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="rounded-full border-border h-11"
                                /> */}
                                <FormInput name={`Work_Experience.${index}.employer`} label="Employer" placeholder="Enter your name of the company you worked for" control={control} />
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FormInput name={`Work_Experience.${index}.duration_start`} label="Duration" placeholder="Enter duration (e.g., 2 years)" control={control} />
