...
export function WorkExperience({
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl 3xl:text-[32px] text-[#E97451] font-urbanist mt-8">
        Work Experience
      </h2>
          ...
          {index >= 0  && (
            <div className="flex items-center justify-between">
              ...
              >
                <button
                  type="button"
                  className="text-white bg-[#E97451] size-5 rounded-full p-1 flex items-center justify-center hover:bg-[#E97451] cursor-pointer"
                >
                  X
                </button>
