    ...
    <section className="w-full bg-white py-8 sm:py-20 3xl:py-30 3xl:pb-35">
      <ContainerWidget>
        <ScrollWidget delay={0.2}>
          <h2 className="font-urbanist font-normal text-left md:text-center text-black text-[32px] sm:text-[32px] md:text-[36px] lg:text-[42px] xl:text-[48px] 2xl:text-[52px] 3xl:text-[64px] mb-4 sm:mb-5 md:mb-12 lg:mb-10">
            {data?.Title}
          </h2>
