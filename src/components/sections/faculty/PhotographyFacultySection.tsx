      ...
      <ContainerWidget>
        <ScrollWidget delay={0.2}>
          <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16 xl:mb-18 2xl:mb-20 3xl:mb-20">
            <h2 className=" text-left md:text-center font-urbanist font-normal text-black text-[28px] sm:text-[32px] md:text-[36px] lg:text-[42px] xl:text-[48px] 2xl:text-[52px] 3xl:text-[58px] mb-3 sm:mb-4 3xl:mb-5">
              {data?.Title}
            </h2>
            ...
            <p className=" text-left md:text-center font-mulish text-black text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] xl:text-[17px] 2xl:text-[17px] 3xl:text-[18px] max-w-[280px] s:max-w-[320px] m:max-w-[350px] xss:max-w-[370px] xs:max-w-[450px] sm:max-w-[500px] md:max-w-[600px] lg:max-w-[650px] xl:max-w-[700px] 2xl:max-w-[750px] 3xl:max-w-[770px] mx-auto">
              {data?.Description}
            </p>
          </div>
        </ScrollWidget>
