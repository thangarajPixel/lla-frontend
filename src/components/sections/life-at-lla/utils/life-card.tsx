...
const LifeCard = ({ card }: LifeCardProps) => (
  <div className="px-6 py-6 bg-[#ECECEC] min-w-[300px] sm:min-w-[280px] m:min-w-[340px] xss:min-w-[380px] xs:min-w-[200px]  md:min-w-[180px] lg:min-w-[180px] xl:min-w-[200px] 2xl:min-w-[250px]  3xl:min-w-[300px] p-3 sm:p-4 lg:p-4 xl:p-5 3xl:p-6 hover:bg-white border hover:border-[#E97451] transition-all duration-300 cursor-pointer">
    ...
    s:w-[260px] s:h-[210px] m:w-[290px] m:h-[210px] xss:w-[330px] xss:h-[210px] xs:w-[190px] xs:h-[140px]
    sm:w-[250px] sm:h-[210px] md:w-[190px] md:h-[130px] lg:w-[190px] lg:h-[130px]
