import ImageWidget from "@/components/widgets/ImageWidget";
 ...
 const LifeCard = ({ card }: any) => (
  <div className="px-6 py-6 bg-[#ECECEC] min-w-[320px] sm:min-w-[300px]  md:min-w-[200px] xl:min-w-[200px] 2xl:min-w-[280px]  3xl:min-w-[300px] p-3 sm:p-4 lg:p-4 xl:p-5 3xl:p-6 hover:bg-white hover:border hover:border-[#E97451] transition-all duration-500 cursor-pointer">
