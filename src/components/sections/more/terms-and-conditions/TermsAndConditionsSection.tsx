...
import type { TermsAndConditionsProps } from "./utils/terms-and-conditions";

const TermsAndConditionsSection = ({ data }: TermsAndConditionsProps) => {
  return (
    <section className="relative w-full bg-white py-10 md:py-10">
      <ContainerWidget>
        <div className="max-w-full">
          ...
          {data.TermsAndConditionCard.map((item) => (
