      ...
      >
        <ScrollWidget>
          <div className="flex items-center justify-center mt-40 md:mt-[180px] xl:mt-[150px] 2xl:mt-[140px] 3xl:mt-[150px]">
            <ContainerWidget>
              <h1
                className="font-urbanist leading-24 font-normal mb-6 text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-[85px] 3xl:text-[112px] max-w-[850] 3xl:max-w-[1120px]"
              >
